...
#' 
#' assertions for flow and job name: both are characters of length 1 and both exist in flows
#'
#' @param flow_name string flow name
#' @param job_name string job name
#' 
#' @importFrom checkmate assert check_character check_names
assert_flow_job_name <- function(flow_name,job_name) {
